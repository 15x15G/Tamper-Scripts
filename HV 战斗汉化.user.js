...
(function () {
    ...
    */
    ...
    /////////////////////////////////////////////////////战斗行动说明，战斗行动名称放在最后防止打断句子
        ...
        'Choose from the Battle Actions highlighted above, and use them to defeat your enemies listed to the right. When all enemies are reduced to zero Health, you win. If your Health reaches zero, you are defeated.' : '选择以上的任一个行动来打倒右侧的敌人。当所有敌人生命为0时，你获得胜利，当你的生命为0时，你被打败。',
        '' : '',
        '' : '',
        '' : '',
        '' : '',
    ...
    /////////////////////////////////////////////////////状态说明，此部分字典可能大量缺失
        ...
        'You are channeling the mystic forces of the ever-after. Your next spell is powered up by 50%, and costs no MP.' : '你正不断地引导出神祕的力量，你下一次施放的咒语会增强 50% 效果且只会消耗 1 点魔力值。',
        '' : '',
        ...
        'You have reached a high level of attunement with the arcane forces, increasing your magic damage by' : '你目标经由奥术的力量点化而到达更高的境界，强化魔法的威力',
        ...
        '' : '',
        '' : '持续抽取目标的灵力值。少量的灵力值会回到玩家身上。',
        '' : '持续抽取目标的魔力值。少量的魔力值会回到玩家身上。',
        '' : '',
        '' : '',
        '' : '',
        '' : '',
        ...
        '' : '',
        '' : '',
        '' : '此目标的生命之核已被点燃，对它造成持续性物理伤害。',
        '' : '此目标的生命之核持续著无法修补的腐败，对它造成持续性物理伤害。',
        '' : '',
        '' : '',
        '' : '',
        //战斗风格效果
        'Increases attack damage by 15% and attack accuracy by 50%. Also grants a 20% chance per stack to overwhelm enemy parry.' : '增加攻击伤害 15% 和攻击准确度 50%，持续 4 回合。每一道特效有 20% 反制招架的机率，最多可堆叠 5 道特效 (每一道 20% 机率无视怪物的成功招架)。',
        ...
        'The destruction of the future has increased the attack power of her allies.' : '诗蔻蒂被击倒，消灭了“未来”，强化它的攻击力。',
        'The destruction of the past has increased the defensive power of her allies.' : '兀儿德被击倒，消灭了“过去”，强化它的防御力。',
        'The destruction the present has increased the attack speed of her allies.' : '蓓儿丹娣被击倒，消灭了“现在”，强化它的攻击速度。',
        '' : '',
        '' : '',
        '' : '',
        '' : '',
    /////////////////////////////////////////////////////状态名称，同上有缺失，部分名字和技能、技巧名字相同
        '' : '',
        'Refreshment' : '提神',
        'Regeneration' : '再生',
        'Replenishment' : '补给',
        ...
        'Fire Burning Soul' : '焚烧的灵魂',
        'Soul Ripened Soul' : '鲜美的灵魂',
        'Vital Theft' : '生命吸窃',
        'Ether Theft' : '以太吸窃',
        'Spirit Theft' : '灵力吸窃',
        '' : '',
    ...
    function init() {
        replace();
        observer.observe(document.getElementById('infopane'),{childList:true,subtree:true});
    }
