...
(function() {
    'use strict';
    if(window.location.href.includes('yamibo') && document.querySelector('#nv_forum > div.oyheader > div > div > ul.header-tool.y > li > a:nth-child(3)')?.innerHTML.includes("签到")==true){
